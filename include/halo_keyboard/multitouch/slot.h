...
#ifndef HALO_KEYBOARD_MULTITOUCH_SLOT_H_
#define HALO_KEYBOARD_MULTITOUCH_SLOT_H_

#include <linux/input.h>
#include <unordered_map>

#include "halo_keyboard/multitouch/event_key.h"
...
#endif  // HALO_KEYBOARD_MULTITOUCH_SLOT_H_
