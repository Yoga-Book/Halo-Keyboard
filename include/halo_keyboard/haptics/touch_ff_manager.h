...
#ifndef HALO_KEYBOARD_HAPTICS_TOUCH_FF_MANAGER_H_
#define HALO_KEYBOARD_HAPTICS_TOUCH_FF_MANAGER_H_
...
class TouchFFManager {
 ...
 public:
  ...
  TouchFFManager(const TouchFFManager&) = delete;
  TouchFFManager& operator=(const TouchFFManager&) = delete;
...
#endif  // HALO_KEYBOARD_HAPTICS_TOUCH_FF_MANAGER_H_
